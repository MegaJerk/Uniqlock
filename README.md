...
But if you'd like to run it locally, download the latest release. Just remember that you'll need to open some sort of web server to get it working as this uses Web Workers, which are blocked by from running under the file: protocol. An easy way to do that would be to:

- Download Visual Studio Code

- Open the Directory containing the Uniqlock Rewind project

- Open the index.html file

- Click on the "Go Live" icon in the bottom right-hand side of the editor.
